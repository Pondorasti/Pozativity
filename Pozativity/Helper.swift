...
extension UIColor {
    ...
    static let mgDestructive = #colorLiteral(red: 0.9960784314, green: 0.2901960784, blue: 0.2862745098, alpha: 1) //FF6978
    static let mgInformative = #colorLiteral(red: 0.007843137255, green: 0.662745098, blue: 0.9176470588, alpha: 1)
    static let mgGray = #colorLiteral(red: 0.9607843137, green: 0.9607843137, blue: 0.9607843137, alpha: 1)
